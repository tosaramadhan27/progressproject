...
import 'package:attedance/models/absensi_response.dart';
...
class _AbsenPageState extends State<AbsenPage> {
  ...
  Future savePresensi(latitude, longitude) async {
    AbsensiResponseModel absensiResponseModel;
    ...
    var response = await myHttp.post(
        Uri.parse("http://127.0.0.1:8000/api/absensi"),
        body: body,
        headers: headers);
    
    absensiResponseModel = 
        AbsensiResponseModel.fromJson(json.decode(response.body));

    // if (absensiResponseModel.success) {
